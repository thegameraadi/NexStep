...
const RESOURCE_LINKS = [
  ...
  { label: 'Glossary', to: '/knowledge' },
  { label: 'Timelines', to: '/knowledge' },
  { label: 'Official Links', to: '/knowledge' },
...
const LEGAL_LINKS = [
  ...
  { label: 'Disclaimer', to: '/legal?tab=disclaimer' },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex items-center gap-3 mt-5">
              <button className="w-8 h-8 rounded-lg bg-navy-800 flex items-center justify-center text-navy-300 hover:text-white hover:bg-navy-700 transition-colors" aria-label="GitHub">
              ...
              <button className="w-8 h-8 rounded-lg bg-navy-800 flex items-center justify-center text-navy-300 hover:text-white hover:bg-navy-700 transition-colors" aria-label="X / Twitter">
              ...
              <button className="w-8 h-8 rounded-lg bg-navy-800 flex items-center justify-center text-navy-300 hover:text-white hover:bg-navy-700 transition-colors" aria-label="LinkedIn">
          ...
          {/* Platform */}
          <div>
            <h4 className="text-xs font-bold uppercase tracking-widest text-navy-400 mb-4">Platform</h4>
            <ul className="space-y-2.5">
              {PLATFORM_LINKS.map(link => (
                <li key={link.to + link.label}>
                  <Link to={link.to} className="text-sm text-navy-300 hover:text-white transition-colors">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          {/* Resources */}
          <div>
            <h4 className="text-xs font-bold uppercase tracking-widest text-navy-400 mb-4">Resources</h4>
            <ul className="space-y-2.5">
          ...
          {/* Legal */}
          <div>
            <h4 className="text-xs font-bold uppercase tracking-widest text-navy-400 mb-4">Legal</h4>
            <ul className="space-y-2.5">
      ...
      <div className="border-t border-navy-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          ...
          <p className="text-xs text-navy-500">
            ...
            <Link to="/legal?tab=disclaimer" className="underline hover:text-navy-300 transition-colors">
